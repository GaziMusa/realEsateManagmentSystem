...
const validate = values => {
    ...
    if (!values.age) {
        ...
        errors.age = 'Only number r allowed';
...
const AgentSignIn = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            // console.log(values)
            const signin = async () => {
                const result = await axios.post('/agentRegistration', {
                    type: "agent",
                ...
                if (result.data) {
                    ...
                    navigate('/agentDashboard/agentProfile');
                    console.log(result)
                } else {
                    setErr("email or mobile number is already in use")
                }
            }
            signin()
                    ...
                    <div className='col-sm-12 col-md-6 col-lg-4 '>
                        <div className='shadow rounded bg-light p-3'>
                            ...
                            <form onSubmit={formik.handleSubmit}>
                                ...
                                {err ? <small className='text-danger fw-bolder'>*{err}</small> : null}
